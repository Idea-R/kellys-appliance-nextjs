        ...
        <div className="text-center mb-12">
          ...
          {loading ? (
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-2xl font-bold text-gray-900 ml-2">Loading...</span>
            </div>
          ) : error ? (
            <div className="flex items-center justify-center gap-2 mb-6">
              <div className="flex text-yellow-400">
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              <div className="flex text-yellow-400">
                {[...Array(5)].map((_, i) => (
                  <svg
                    key={i}
                    className={`w-6 h-6 fill-current ${i < Math.round(data.rating) ? 'text-yellow-400' : 'text-gray-300'}`}
                    viewBox="0 0 20 20"
                  >
                    <path d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z"/>
                  </svg>
              ...
              <span className="text-2xl font-bold text-gray-900 ml-2">{data.rating.toFixed(1)}/5</span>
              <span className="text-gray-600">Based on {data.count} Google Reviews</span>
            </div>
          ) : null}
        </div>
