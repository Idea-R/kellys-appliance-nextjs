...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://kellysappliancerepair.com/service-locations/san-rafael',
  },
};

export default function SanRafaelPage() {
  const breadcrumbs = generateBreadcrumbs('/appliance-repair-san-rafael', metadata.title);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 items-start">
            <div>
              ...
              <p className="text-gray-700">From the Frank Lloyd Wright–designed Civic Center to vibrant downtown dining, San Rafael is a hub for Marin. We deliver fast, reliable appliance repair to keep your home ready for busy weeks and relaxed weekends alike.</p>
            </div>
            ...
            <div className="space-y-4">
              <NearbyCityLinks currentSlug="san-rafael" />
              <RelatedServiceLinks />
            </div>
          </div>
        </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-700">Visit the <a href="https://www.srchamber.com/" target="_blank" rel="noopener noreferrer" className="text-green-700 underline">San Rafael Chamber of Commerce</a> for local business resources and events.</p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <div className="text-gray-900 text-sm">Trusted in San Rafael for decades</div>
              </div>
            </div>
          </div>
        </div>
