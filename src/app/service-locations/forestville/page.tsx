...
export const metadata = {
  ...
  description: 'Professional appliance repair services in Forestville, CA. Factory authorized repairs for all major brands. Call (707) 664-9702 for same-day service.',
};
...
export default function ForestvillePage() {
  return (
    <Layout>
      <section className="bg-gradient-to-r from-green-800 to-green-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Appliance Repair in Forestville</h1>
            <p className="text-xl mb-8 max-w-3xl mx-auto">Professional appliance repair services in Forestville, CA. Factory authorized service with 90-day guarantee.</p>
      ...
      <CityJsonLd city="Forestville" slug="forestville" />
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-700">Visit the <a href="https://www.forestvillechamber.org/" target="_blank" rel="noopener noreferrer" className="text-green-700 underline">Forestville Chamber of Commerce</a> for local business resources and events.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 items-start">
            <div>
              ...
              <p className="text-gray-700">Forestville sits along the Russian River with redwoods, wineries, and swim spots close by. We keep fridges cold and laundry spinning so weekends on the river stay effortless.</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="font-semibold text-gray-900 mb-3">Top 3 Eats</h3>
              <ul className="list-disc pl-5 text-gray-700 space-y-1">
                <li>Backyard Forestville</li>
                <li>Canneti Roadhouse Italiana</li>
                <li>El Molino Central (nearby)</li>
              </ul>
            </div>
            <div className="space-y-4">
              <NearbyCityLinks currentSlug="forestville" />
              <RelatedServiceLinks />
            </div>
          </div>
        </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start"><MapPinIcon className="w-6 h-6 text-green-600 mr-3 mt-0.5" /><div><strong>Local Experts</strong><div className="text-gray-600 text-sm">Serving Forestville since 1975</div></div></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="text-3xl font-bold text-gray-900 mb-4">Our Services in Forestville</h2></div>
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Need Appliance Repair in Forestville?</h2>
          <p className="text-xl mb-8">Serving Forestville with professional appliance repair services since 1975</p>
