...
export const metadata = {
  title: "Appliance Repair Glen Ellen - Kelly's Appliance Center",
  description: 'Professional appliance repair services in Glen Ellen, CA. Factory authorized repairs for all major brands. Call (707) 664-9702 .',
  alternates: {
    canonical: '/service-locations/glen-ellen',
  },
};
...
export default function GlenEllenPage() {
  const breadcrumbs = generateBreadcrumbs('/service-locations/glen-ellen', metadata.title);
  ...
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-r from-green-800 to-green-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Appliance Repair in Glen Ellen</h1>
            <p className="text-xl mb-8 max-w-3xl mx-auto">Professional appliance repair services in Glen Ellen, CA. Factory authorized service with 90-day guarantee.</p>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start"><MapPinIcon className="w-6 h-6 text-green-600 mr-3 mt-0.5" /><div><strong>Local Experts</strong><div className="text-gray-600 text-sm">Serving Glen Ellen since 1975</div></div></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="text-3xl font-bold text-gray-900 mb-4">Our Services in Glen Ellen</h2></div>
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Need Appliance Repair in Glen Ellen?</h2>
          <p className="text-xl mb-8">Serving Glen Ellen with professional appliance repair services since 1975</p>
