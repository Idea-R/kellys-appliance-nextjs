...
export const metadata = {
  ...
  description: 'Professional appliance repair services in Dillon Beach, CA. Factory authorized repairs for all major brands. Call (707) 664-9702 for same-day service.',
};
...
export default function DillonBeachPage() {
  return (
    <Layout>
      <section className="bg-gradient-to-r from-green-800 to-green-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Appliance Repair in Dillon Beach</h1>
            <p className="text-xl mb-8 max-w-3xl mx-auto">Professional appliance repair services in Dillon Beach, CA. Factory authorized service with 90-day guarantee.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 items-start">
            <div>
              ...
              <p className="text-gray-700">Dillon Beach is surf, sand, and salt air—plus quiet coastal nights. We keep appliances reliable in the marine environment so beach houses and getaways stay comfortable.</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-6">
              <h3 className="font-semibold text-gray-900 mb-3">Top 3 Eats</h3>
              <ul className="list-disc pl-5 text-gray-700 space-y-1">
                <li>William Tell House (Tomales)</li>
                <li>Nick’s Cove (Marshall)</li>
                <li>Dillon Beach Coastal Kitchen</li>
              </ul>
            </div>
            <div className="space-y-4">
              <NearbyCityLinks currentSlug="dillon-beach" />
              <RelatedServiceLinks />
            </div>
          </div>
        </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start"><MapPinIcon className="w-6 h-6 text-green-600 mr-3 mt-0.5" /><div><strong>Local Experts</strong><div className="text-gray-600 text-sm">Serving Dillon Beach since 1975</div></div></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="text-3xl font-bold text-gray-900 mb-4">Our Services in Dillon Beach</h2></div>
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Need Appliance Repair in Dillon Beach?</h2>
          <p className="text-xl mb-8">Serving Dillon Beach with professional appliance repair services since 1975</p>
