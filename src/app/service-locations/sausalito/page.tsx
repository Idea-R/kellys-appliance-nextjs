...
export const metadata = {
  title: "Appliance Repair Sausalito - Kelly's Appliance Center",
  description: 'Find local appliance repair near you in Sausalito, CA. Professional appliance repair services with factory authorized repairs for all major brands. Call (707) 664-9702.',
  alternates: {
    canonical: '/service-locations/sausalito',
  },
};
...
export default function SausalitoPage() {
  const breadcrumbs = generateBreadcrumbs('/service-locations/sausalito', metadata.title);
  ...
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-r from-green-800 to-green-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Appliance Repair in Sausalito</h1>
            <p className="text-xl mb-8 max-w-3xl mx-auto">Professional appliance repair services in Sausalito, CA. Factory authorized service with 90-day guarantee.</p>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-700">Visit the <a href="https://www.sausalito.org/" target="_blank" rel="noopener noreferrer" className="text-green-700 underline">Sausalito Chamber of Commerce</a> for local business resources and events.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start"><MapPinIcon className="w-6 h-6 text-green-600 mr-3 mt-0.5" /><div><strong>Local Experts</strong><div className="text-gray-600 text-sm">Serving Sausalito since 1975</div></div></div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 items-start">
            <div>
              ...
              <p className="text-gray-700">Bay views, art galleries, and waterfront paths make Sausalito a destination. We help keep kitchens and laundry rooms ready for everyday living between ferry rides and coastal strolls.</p>
            </div>
            <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="space-y-4">
              <NearbyCityLinks currentSlug="sausalito" />
              <RelatedServiceLinks />
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="text-3xl font-bold text-gray-900 mb-4">Our Services in Sausalito</h2></div>
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Need Appliance Repair in Sausalito?</h2>
          <p className="text-xl mb-8">Serving Sausalito with professional appliance repair services since 1975</p>
      ...
      <CityJsonLd city="Sausalito" slug="sausalito" />
    </Layout>
  );
}
