...
export const metadata = {
  ...
  description: 'Professional appliance repair services in Sausalito, CA. Factory authorized repairs for all major brands. Call (707) 664-9702 for same-day service.',
};
