...
export const metadata = {
  ...
  description: 'Find local appliance repair near you in Healdsburg, CA. Professional appliance repair services with factory authorized repairs for all major brands. Call (707) 664-9702.',
  alternates: {
    canonical: '/service-locations/healdsburg',
  },
};
...
export default function HealdsburgPage() {
  const breadcrumbs = generateBreadcrumbs('/service-locations/healdsburg', metadata.title);
  ...
  return (
    <Layout>
      ...
      <section className="bg-gradient-to-r from-green-800 to-green-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">Appliance Repair in Healdsburg</h1>
            <p className="text-xl mb-8 max-w-3xl mx-auto">Professional appliance repair services in Healdsburg, CA. Factory authorized service with 90-day guarantee.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8 items-start">
            <div>
              ...
              <p className="text-gray-700">Healdsburg’s plaza anchors a world-class food and wine scene with small-town warmth. Whether you’re prepping for a dinner party or hosting weekend guests, our authorized repairs help keep the heart of your home running smoothly.</p>
            </div>
            ...
            <div className="space-y-4">
              <NearbyCityLinks currentSlug="healdsburg" />
              <RelatedServiceLinks />
            </div>
          </div>
        </div>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <p className="text-gray-700">Visit the <a href="https://www.healdsburg.com/" target="_blank" rel="noopener noreferrer" className="text-green-700 underline">Healdsburg Chamber of Commerce</a> for local business resources and events.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="text-3xl font-bold text-gray-900 mb-4">Our Services in Healdsburg</h2></div>
      ...
      <section className="py-16 bg-green-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Need Appliance Repair in Healdsburg?</h2>
          <p className="text-xl mb-8">Serving Healdsburg with professional appliance repair services since 1975</p>
      ...
      <CityJsonLd city="Healdsburg" slug="healdsburg" />
    </Layout>
  );
}
