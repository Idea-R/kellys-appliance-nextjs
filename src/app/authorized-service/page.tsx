...
export const metadata: Metadata = {
  ...
  description: 'Factory authorized repair for Whirlpool, KitchenAid, Maytag, JennAir, Bosch, Thermador, Gaggenau, Viking, Dacor, and InSinkErator. Genuine parts and manufacturer-guideline service in Sonoma County.',
  alternates: {
    canonical: '/authorized-service',
  },
  openGraph: {
    title: "Authorized Appliance Service | Kelly's Appliance Center",
    description: 'Factory authorized repair for Whirlpool, KitchenAid, Maytag, JennAir, Bosch, Thermador, Gaggenau, Viking, Dacor, and InSinkErator. Genuine parts and manufacturer-guideline service.',
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              We service many major appliance brands. Factory-authorized for select brands (Whirlpool, KitchenAid, Maytag, JennAir, Bosch, Thermador, Gaggenau, Viking, Dacor, and InSinkErator).
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mt-16 bg-green-700 text-white rounded-2xl p-12">
            ...
            <p className="text-xl text-white/90 mb-2">
              Factory-authorized for Whirlpool, KitchenAid, Maytag, JennAir, Bosch, Thermador, Gaggenau, Viking, Dacor, and InSinkErator.
            </p>
