...
export const metadata = {
  ...
  description: 'Professional oven, range, wall oven, cooktop, and vent hood repair. Expert diagnosis of temperature issues, heating elements, and controls. Call (707) 664-9702.',
  alternates: {
