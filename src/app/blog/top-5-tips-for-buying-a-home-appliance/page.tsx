    ...
    <Layout>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            <em>&quot;They don&apos;t make them like they used to.&quot;</em> It may be a cliché, but this saying rings true when it comes to home appliances. The fact is, appliances aren&apos;t built to last the way they were in the 1960s, so if you&apos;re looking for a washer with a 30-year warranty, you&apos;ll need to temper your expectations. That said, regular maintenance and timely repairs can extend the life of any appliance significantly, whether it&apos;s a <Link href="/services/refrigerator-repair" className="text-green-600 hover:text-green-700">refrigerator</Link>, <Link href="/services/dishwasher-repair" className="text-green-600 hover:text-green-700">dishwasher</Link>, or <Link href="/services/dryer-repair" className="text-green-600 hover:text-green-700">dryer</Link>.
          </p>
          <p>
