      ...
      <article className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-green max-w-none">
            ...
            <p className="mb-4 text-gray-700 leading-relaxed">
              Kelly&apos;s Appliance Center has been repairing ovens in Sonoma, Marin, and Napa counties since 1975. We&apos;re Diamond Certified, factory authorized for Viking, Thermador, Bosch, and KitchenAid, and we service Sub-Zero, Wolf, and every major brand, and we carry common oven parts on our trucks so a lot of repairs finish in a single visit.
            </p>
            <p className="mb-6 text-gray-700 leading-relaxed">
