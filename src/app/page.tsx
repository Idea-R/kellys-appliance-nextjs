        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-2 mb-6">
              ...
              <span className="text-gray-600">Based on 109 Google Reviews</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700 mb-4">"7 month nightmare with Whirlpool on a warranty claim including multiple visits from their warranty technicians and nothing but run around. Then they sent Dane from Kelly's Appliance out and 30 minutes later it was fixed!!!!"</p>
              <p className="font-semibold text-gray-900">- Robert Smith</p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700 mb-4">"Extremely efficient service will definitely use again. James was professional and is a highly skilled technician and very pleasant to deal with. Abbey was also a pleasure to deal with."</p>
              <p className="font-semibold text-gray-900">- Justin Hegarty</p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700 mb-4">"Prompt, friendly and reliable! From the extremely friendly, Abby, who answered my call, to the moment Shane showed up and diagnosed the problem quickly, Kelly's Appliances was extremely professional."</p>
              <p className="font-semibold text-gray-900">- Jim C</p>
            </div>
          </div>
